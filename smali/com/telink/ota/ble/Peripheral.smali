...
.method private enableNotification(Lcom/telink/ota/ble/Peripheral$CommandContext;Ljava/util/UUID;Ljava/util/UUID;)V
    ...
    .line 679
    iget-object v2, p0, Lcom/telink/ota/ble/Peripheral;->gatt:Landroid/bluetooth/BluetoothGatt;

    invoke-virtual {v2, p3, v0}, Landroid/bluetooth/BluetoothGatt;->setCharacteristicNotification(Landroid/bluetooth/BluetoothGattCharacteristic;Z)Z
...
.method private declared-synchronized processCommand(Lcom/telink/ota/ble/Peripheral$CommandContext;)V
    ...
    .line 415
    iget-object v1, v0, Lcom/telink/ota/ble/Command;->type:Lcom/telink/ota/ble/Command$CommandType;
    ...
    invoke-virtual {v0}, Lcom/telink/ota/ble/Command;->toString()Ljava/lang/String;
    ...
    .line 419
    sget-object v2, Lcom/telink/ota/ble/Peripheral$2;->$SwitchMap$com$telink$ota$ble$Command$CommandType:[I
    ...
    .line 448
    :pswitch_0
    iget-object v1, v0, Lcom/telink/ota/ble/Command;->serviceUUID:Ljava/util/UUID;

    iget-object v0, v0, Lcom/telink/ota/ble/Command;->characteristicUUID:Ljava/util/UUID;

    invoke-direct {p0, p1, v1, v0}, Lcom/telink/ota/ble/Peripheral;->disableNotification(Lcom/telink/ota/ble/Peripheral$CommandContext;Ljava/util/UUID;Ljava/util/UUID;)V
    ...
    invoke-direct {p0, p1, v1, v0}, Lcom/telink/ota/ble/Peripheral;->enableNotification(Lcom/telink/ota/ble/Peripheral$CommandContext;Ljava/util/UUID;Ljava/util/UUID;)V
    ...
    .line 438
    iget-object v2, v0, Lcom/telink/ota/ble/Command;->serviceUUID:Ljava/util/UUID;

    iget-object v3, v0, Lcom/telink/ota/ble/Command;->characteristicUUID:Ljava/util/UUID;

    const/4 v4, 0x1

    iget-object v5, v0, Lcom/telink/ota/ble/Command;->data:[B
    ...
    iget-object v2, v0, Lcom/telink/ota/ble/Command;->characteristicUUID:Ljava/util/UUID;

    iget-object v0, v0, Lcom/telink/ota/ble/Command;->descriptorUUID:Ljava/util/UUID;

    invoke-direct {p0, p1, v1, v2, v0}, Lcom/telink/ota/ble/Peripheral;->readDescriptor(Lcom/telink/ota/ble/Peripheral$CommandContext;Ljava/util/UUID;Ljava/util/UUID;Ljava/util/UUID;)V
    ...
    invoke-direct {p0, p1, v1, v0}, Lcom/telink/ota/ble/Peripheral;->readCharacteristic(Lcom/telink/ota/ble/Peripheral$CommandContext;Ljava/util/UUID;Ljava/util/UUID;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method protected connect()V
    ...
    iget-object v2, p0, Lcom/telink/ota/ble/Peripheral;->mContext:Landroid/content/Context;

    invoke-virtual {v0, v2, v4, p0}, Landroid/bluetooth/BluetoothDevice;->connectGatt(Landroid/content/Context;ZLandroid/bluetooth/BluetoothGattCallback;)Landroid/bluetooth/BluetoothGatt;
...
.method public refreshCache()Z
    ...
    .line 315
    iget-object v2, p0, Lcom/telink/ota/ble/Peripheral;->mDelayHandler:Landroid/os/Handler;
